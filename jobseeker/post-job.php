...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO job_listings (user_id, title, description, salary, tags, company, address, city, state, phone, email, requirements, benefits) 
            VALUES (:user_id, :title, :description, :salary, :tags, :company, :address, :city, :state, :phone, :email, :requirements, :benefits)";
...
<body class="bg-slate-50 text-slate-800 font-sans antialiased pb-24">
  ...
  <section class="bg-gradient-to-r from-brand-900 to-indigo-900 pt-32 pb-24 text-center">
    <div class="container mx-auto px-4">
      <h2 class="text-3xl md:text-4xl font-display font-bold text-white mb-3">Create Job Listing</h2>
    ...
    <div class="bg-white p-6 md:p-10 rounded-3xl shadow-xl shadow-brand-900/5 border border-slate-100 w-full max-w-4xl">
      <form method="POST">
        <div class="mb-10">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div class="md:col-span-2">
              ...
              <input type="text" name="title" placeholder="e.g. Senior Software Engineer" class="input-field"
                required />
            </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input type="text" name="salary" placeholder="80,000" class="input-field pl-9" />
              </div>
            </div>

            <div>
              <label class="block text-sm font-semibold text-slate-700 mb-2">Benefits</label>
              <input type="text" name="benefits" placeholder="e.g. Healthcare, 401(k), Remote" class="input-field" />
            </div>
            ...
            <div class="md:col-span-2">
              ...
              <input type="text" name="tags" placeholder="e.g. development, coding, java" class="input-field" />
            </div>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div class="md:col-span-2">
              <label class="block text-sm font-semibold text-slate-700 mb-2">Company Name <span
                  class="text-rose-500">*</span></label>
              <input type="text" name="company" placeholder="e.g. Jobly Technologies" class="input-field" required />
            </div>

            <div class="md:col-span-2">
              <label class="block text-sm font-semibold text-slate-700 mb-2">Office Address</label>
              <input type="text" name="address" placeholder="123 Innovation Drive" class="input-field" />
            </div>
            ...
            <div>
              ...
              <input type="text" name="phone" placeholder="+1 (555) 000-0000" class="input-field" />
            </div>

            <div>
              <label class="block text-sm font-semibold text-slate-700 mb-2">Application Email <span
                  class="text-rose-500">*</span></label>
              <input type="email" name="email" placeholder="jobs@company.com" class="input-field" required />
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row items-center gap-4 pt-6 border-t border-slate-100">
          ...
          <a href="index.php"
            class="w-full md:w-auto btn-outline border-rose-200 text-rose-600 hover:bg-rose-50 px-8 py-3.5 justify-center rounded-xl">
            Cancel
          </a>
        </div>
      </form>
